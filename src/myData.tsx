...
export const baseInfo: BaseInfo = {
  ...
  education: [
    {
      time: { start: +moment("2010.09"), end: +moment("2014.07") },
      qualification: "本科",
      subject: "生物工程",
      school: "广东石油化工学院",
    },
...
export const companys: Company[] = [
  {
    name: "安徽省刀锋网络科技有限公司",
    position: "前端开发工程师",
    time: { start: +moment("2022.04"), end: +moment("2023.2.16") },
